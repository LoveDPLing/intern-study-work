...
$(document).ready(function () {
  ...
  function showPicture(a) {
    switch (a) {
      case 1: $('.main').css({ "background": "url(images/image1.png) no-repeat","background-size": "100%" });
        // $('.main-inner').css({ "background": "url(image1.jpg) no-repeat" });
        break;
      case 2: $('.main').css({ "background": "url(images/image2.png) no-repeat" ,"background-size": "100%"});
        // $('.main-inner').css({ "background": "url(image2.jpg) no-repeat" });
        break;
      case 3: $('.main').css({ "background": "url(images/image3.png) no-repeat" ,"background-size": "100%"});
